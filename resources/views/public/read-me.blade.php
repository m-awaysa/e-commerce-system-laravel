...
<div class="container">
    ...
    <div class="mt-5">
        ...
        <h5 class="text-success">Password: guestguest</h5>
        <h2>mailtrap account:</h2>
        <h6 class="text-danger ">
            *for testing email verification or reset password you have to login at mailtrap.com using this account and
            check th inbox*
        </h6>
        <h5 class="text-success">Email: awaysa.guest@gmail.com</h5>
        <h5 class="text-success">Password: guestguest</h5>
        <img src="{{asset('images/mailtrap.png')}}" alt="..." style="max-width:100%; ">
        ...
        <ol class=" list-group-numbered">
            ...
            <img src="{{asset('images/part.png')}}" alt="..." style="max-width:100%; ">
        </ol>
        <h3>User(salesman)</h3>
        <h5>1.Cart</h5>
        <ol class=" list-group-numbered">

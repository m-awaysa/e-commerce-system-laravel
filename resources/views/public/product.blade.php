    ...
    <div class="all-content">
        ...
        <div class="  side-product-filter border border-1">
            ...
            <form action="{{route('public.products')}}">
                <button class="btn-lg btn bg-dark filter-btn border-0 rounded-0 text-light w-100 " type="submit">Press To Filter</button>
        ...
        <div class="product-container  border-top">
            ...
            <div class="card card-product rounded-0" >
                <a class="text-dark" href="{{route('public.products.product',$product)}}">
                    <img src="{{asset('images/productImages/'.$product->image)}}" onerror="this.src='  <?php echo asset('images/default.png') ?>  ' " 
                    class="ms-4 card-img-top" alt="...">
                    <div class="card-body">

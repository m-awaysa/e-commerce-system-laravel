...
<div id="carousel" class="carousel slide " data-bs-ride="true">
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carousel" data-bs-slide-to="0" class="active carousel-btn" aria-current="true" aria-label="Slide 1"></button>
    @for($x=1;$x < $carouselPart->count(); $x++) <button type="button" data-bs-target="#carousel" data-bs-slide-to="{{$x}}" class=" carousel-btn" aria-label="Slide 2"></button>
      @endfor
  </div>
  <div class="home-carousel-inner ">
    ...
    <div class="bg-dark carousel-item <?php if (!$thereIsAnActive) {
      ...
      <img class="home-d-block " src="{{asset('images/productImages/'.$homeImage->image)}}" onerror="this.src='  <?php echo asset('images/default.png') ?>  ' " alt="No Image">
    ...
    <a class="text-dark" href="{{route('public.products.product',$product->id)}}">
      <div class="card-body-item">
        ...
        <div class="home-image-content">
          <img class="home-product-image" src="{{asset('images/productImages/'.$product->image)}}" onerror="this.src='  <?php echo asset('images/default.png') ?>  ' " alt="">
        </div>

    ...
    <div class="card-body">
      ...
      <div class="d-flex justify-content-between">
        ...
        <div class="d-flex flex-row align-items-center">
          <div>
            <img src="{{asset('images/productImages/'.$cartProduct->image)}}" class="img-fluid rounded-3"
        ...
        <div class="d-flex flex-row align-items-center">
          <div style="width: 55px;">
            <input wire:change="edit({{$cartProduct->id}})" wire:model="amount.{{$cartProduct->id}}"
              id="amount.{{$cartProduct->id}}" type="number" class="fw-normal  col-10"
              value="<?php echo $this->amount[$cartProduct->id] ?>" min="1" max="{{$cartProduct->amount}}">
          </div>
